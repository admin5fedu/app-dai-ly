...
import { readSheetServer, writeSheetServer, getSheetNamesServer, updatePasswordServer } from './google-sheets.js'
...
app.listen(PORT, () => {
  ...
  console.log(`📊 Google Sheets API endpoints available at /api/google-sheets/*`)
})
